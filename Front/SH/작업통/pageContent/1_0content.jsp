...
<!-- 밑부터 메인 프레임 속 내용-->
<div class="screen1"
	style="width: 50%; height: 80%; float: left; background-color: bisque;">
	<h1>메인 프레임의 속의 내용입니다.</h1>
	<p>
	<table width=auto% height="600"
		style="color: #121212; border: 1px solid #000; margin: 10px;" st>
...
<!--오른쪽 메인프레임 시작-->
<div class="screen2"
	style="width: 50%; height: 80%; float: right; background-color: aquamarine;">
	<h1 class="mb-4">메모장</h1>
