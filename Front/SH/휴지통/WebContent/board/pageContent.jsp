...
<div id="content" class="p-4 p-md-5">
	...
	<div class="col-md-6"
		style="width: 50%; height: 40%; float: left; border: 1px solid;">
		<h1>좌상단 프레임.</h1>
		<p>이안에서 forward를 쓰든 include를 쓰든 다른걸 쓰든 계속 내용을 갈아끼우는 형식으로 만들어나갈것
			입니다.</p>
	</div>
	<div class="mb-4"
		style="width: 50%; height: 80%; float: right; border: 1px solid;">
		<h1>우상단 프레임.</h1>
		<p>이안에서 forward를 쓰든 include를 쓰든 다른걸 쓰든 계속 내용을 갈아끼우는 형식으로 만들어나갈것
			입니다.</p>
	</div>
